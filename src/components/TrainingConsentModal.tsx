    ...
    switch (selectedCountry) {
      ...
      case 'chile':
        return [
          ...
          { value: 'magallanes', label: 'Magallanes y Antártica' }
        ];
      case 'venezuela':
        return [
          { value: 'amazonas', label: 'Amazonas' },
          ...
          { value: 'caracas', label: 'Distrito Capital' }
        ];
      case 'ecuador':
        return [
      ...
      case 'nicaragua':
        return [
          ...
          { value: 'raan', label: 'Región Autónoma Atlántico Norte' },
          { value: 'raas', label: 'Región Autónoma Atlántico Sur' }
        ];
      case 'honduras':
        return [
      ...
      case 'republica-dominicana':
        return [
          ...
          { value: 'elias-pina', label: 'Elías Piña' },
          ...
          { value: 'san-jose-de-ocoa', label: 'San José de Ocoa' },
          { value: 'san-juan', label: 'San Juan' },
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="region" className="text-sm font-medium">
                  {country === 'spain' ? 'Comunidad Autónoma' : 
                   ...
                   country === 'venezuela' ? 'Estado' : 
                   country === 'ecuador' ? 'Provincia' : 
                   country === 'bolivia' ? 'Departamento' : 
                   country === 'paraguay' ? 'Departamento' : 
                   country === 'uruguay' ? 'Departamento' : 
                   country === 'costa-rica' ? 'Provincia' : 
                   country === 'panama' ? 'Provincia' : 
                   country === 'nicaragua' ? 'Departamento' : 
                   country === 'honduras' ? 'Departamento' : 
                   country === 'el-salvador' ? 'Departamento' : 
                   country === 'guatemala' ? 'Departamento' : 
                   country === 'belize' ? 'Distrito' : 
                   country === 'cuba' ? 'Provincia' : 
                   country === 'republica-dominicana' ? 'Provincia' : 
                   country === 'haiti' ? 'Departamento' : 
                   country === 'puerto-rico' ? 'Municipio' : 
                   country === 'usa' ? 'Estado' : 
                   country === 'brasil' ? 'Estado' : 
