          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg mb-4">
                ...
                <strong>datos que usted nos facilita</strong>: nombre, datos de contacto, credenciales de cuenta, país o
                región, preferencias, y, cuando usted decide aportarlas, <strong>grabaciones de su voz</strong> y sus{" "}
                <strong>transcripciones</strong> o anotaciones asociadas. Si un menor utiliza los Servicios, recogemos
                los datos del progenitor o representante legal necesarios para verificar el consentimiento. Cuando usted
                lo autoriza, también podemos registrar la información de una persona de apoyo (p. ej., cuidador o
                asistente) para comunicaciones operativas.
              </p>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg mb-4">
                Segundo, <strong>datos que se generan automáticamente</strong> cuando usa los Servicios: identificadores
                técnicos de dispositivo y navegador, dirección IP, sistema operativo, idioma, configuración del
                micrófono, métricas de sesión y registros de actividad.
              </p>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                ...
                estrictamente necesaria para activar la funcionalidad que usted solicita. No utilizamos rastreadores de
                publicidad entre sitios ni huellas digitales de dispositivos; nuestro uso de cookies y almacenamiento
                local se limita a fines operativos esenciales, como mantener su sesión y la seguridad.
              </p>
            </section>

            {/* Voice Biometric Nature */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">
                Naturaleza biométrica de su voz y posibles inferencias de salud
              </h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            <section>
              ...
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg mb-4">
                ...
                <strong>prestación del servicio de transcripción</strong>: procesamos sus grabaciones para convertirlas
                en texto y, cuando usted lo solicita, para sintetizar una voz clara que reproduzca su mensaje. Este
                tratamiento se ejecuta para cumplir con el servicio que usted pide y, dada la naturaleza sensible de la
                voz, lo amparamos también en su consentimiento explícito.
              </p>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg mb-4">
                En segundo lugar, <strong>entrenamiento y mejora de modelos</strong>: únicamente si usted lo autoriza de
                forma separada y revocable, utilizamos fragmentos breves de audio, con sus transcripciones y metadatos,
                para entrenar, validar y mejorar nuestros algoritmos de reconocimiento de voz y accesibilidad. Esta
                finalidad es <strong>opcional</strong> y no es necesaria para que la transcripción funcione.
              </p>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            {/* Legal Basis */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Bases jurídicas</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            {/* AI Processing */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Cómo tratamos sus grabaciones con IA</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            {/* Data Retention */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Conservación de datos</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            {/* Security Measures */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Medidas de seguridad</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                ...
                agregación temporal mínima. Aunque trabajamos para mitigar riesgos, ninguna transmisión por Internet es
                completamente segura; si detectáramos una brecha que le afecte, le notificaremos sin dilación indebida
            ...
            {/* Enhanced Rights */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Derechos reforzados y controles del usuario</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                ...
                <strong>supresión acelerada</strong> para datos biométricos y derivados: cuando solicita el borrado,
                eliminamos los datos activos y programamos la purga de copias de seguridad en el siguiente ciclo de
                mantenimiento verificable; si sus datos hubieran contribuido a entrenar un modelo con su consentimiento,
                ejecutamos un proceso de <strong>desvinculación</strong> razonable para que futuras versiones del modelo
                no continúen personalizadas con su información. La retirada del consentimiento de entrenamiento o el
                ejercicio de oposición <strong>no afectará</strong> a su acceso a la transcripción básica. Todos estos
                derechos pueden ejercerse desde el Centro de Privacidad o contactando con el DPO; daremos respuesta
            ...
            {/* Minors */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Menores de edad</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            {/* Communications */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Comunicaciones y marketing</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            {/* Recipients */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Destinatarios y categorías de terceros</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                ...
                información a la estrictamente necesaria, exigimos confidencialidad y medidas de seguridad equivalentes,
                y auditamos su cumplimiento. Si en el futuro colaborásemos con instituciones académicas o socios de
                investigación en proyectos para mejorar la accesibilidad del habla, lo haríamos sobre datos{" "}
                <strong>anonimizados</strong> o con <strong>consentimiento específico</strong> adicional. En caso de
                reestructuración societaria, fusión o adquisición, podríamos transferir los datos a la entidad sucesora,
                que quedaría obligada a respetar esta Política o a solicitar su consentimiento si pretendiera cambios
                materiales.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Transferencias internacionales</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            {/* Cookies */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Cookies y tecnologías similares</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                ...
                comportamental ni plug‑ins de terceros con fines de seguimiento entre sitios. Puede gestionar estas
                tecnologías desde la configuración del navegador; desactivarlas puede degradar ciertas funciones
                esenciales.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">
                Información adicional sobre analítica y uso interno
              </h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">
                Usuarios de California y otros estados de EE. UU.
              </h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                Si usted reside en California u otros estados con legislación específica, puede disponer de derechos
                adicionales como conocer, acceder, corregir o eliminar información, así como optar por que no se{" "}
                <strong>vendan ni compartan</strong> sus datos para publicidad entre contextos. Adagio{" "}
                <strong>no vende</strong> datos personales según la definición aplicable y no comparte información con
                fines de publicidad dirigida. Puede ejercer estos derechos a través del Centro de Privacidad.
              </p>
            </section>

            {/* Policy Updates */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Actualizaciones de esta Política</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                Podemos modificar esta Política para reflejar cambios en la ley, en los Servicios o en nuestras
                prácticas. Publicaremos la nueva versión indicando la <strong>fecha de última revisión</strong> que
                figura al inicio y, cuando el cambio sea material, le informaremos a través de la aplicación o por
                medios razonables y, si la ley lo requiere, solicitaremos nuevamente su consentimiento.
              </p>
            </section>

            {/* Summary of Key Commitments */}
            <section className="bg-[#005C64]/5 border border-[#005C64]/10 rounded-3xl p-8">
              <h2 className="text-xl font-bold mb-4 text-[#005C64]">Resumen operativo de compromisos clave</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed">
                ...
                empleamos <strong>cifrado fuerte</strong>, controles de acceso estrictos y{" "}
                <strong>anonimización</strong>; garantizamos <strong>derechos reforzados</strong> (acceso, supresión,
                oposición a inferencias de salud, retirada de consentimientos inmediata, portabilidad y limitación); y
                mantenemos una <strong>EIPD</strong> activa y revisada, con supervisión continua del riesgo residual.
              </p>
            </section>

            {/* How to Exercise Rights */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">Cómo ejercer sus derechos o plantear dudas</h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                ...
                Nuestro objetivo es responder a todas las solicitudes con claridad y dentro de los plazos legales,
                manteniendo la trazabilidad de cada actuación.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-[#005C64]">
                Anexo de aclaraciones sobre controles técnicos y de eliminación
              </h2>
              <p className="text-[#0D0C1D]/80 leading-relaxed text-lg">
                En la eliminación de datos biométricos y derivados, ejecutamos borrados en sistemas activos y
                programamos la purga en copias de seguridad dentro del ciclo operativo, emitiendo confirmación una vez
                completada. Para conjuntos de datos utilizados en entrenamiento con su consentimiento, aplicamos
                procesos de <strong>despersonalización</strong> y evitamos el reaprovechamiento futuro de sus
                fragmentos; en modelos ya entrenados, adoptamos medidas de <strong>desvinculación razonable</strong> que
                impiden seguir personalizando salidas con su voz. Estos procesos se documentan y están sujetos a
                verificación. En seguridad, además del cifrado, empleamos rotación de claves, segmentación de redes,
                endurecimiento de servidores, registros inmutables y alertado automático de anomalías, junto con
                formación anual obligatoria de nuestro personal en protección de datos biométricos. Si en algún momento
                adoptamos nuevas integraciones o subencargados, lo reflejaremos en esta Política y en nuestro registro
                de actividades, y, de ser necesario, solicitaremos su consentimiento adicional.
              </p>
            </section>
          </div>
        </div>
