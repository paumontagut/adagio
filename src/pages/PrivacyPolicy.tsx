    ...
    <div className="min-h-screen bg-white font-space-grotesk">
          ...
          <Link to="/" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#4169E1] rounded flex items-center justify-center">
              <div className="grid grid-cols-2 gap-0.5">
                ...
                <div className="w-2 h-2 bg-white rounded-sm"></div>
                <div className="w-2 h-2 bg-white rounded-sm"></div>
                <div className="w-2 h-2 bg-[#4169E1]"></div>
              </div>
            </div>
      ...
      <main className="container mx-auto px-6 py-16 max-w-5xl">
        ...
        <div className="max-w-none space-y-10">
          {/* Introduction */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Introducción y alcance</h2>
          ...
          <section className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a] flex items-center gap-2">
          ...
          {/* Responsible Party */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Responsable del tratamiento y contacto</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Data We Collect */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Qué datos tratamos</h2>
            <p className="text-[#374151] leading-relaxed text-base mb-4">
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Naturaleza biométrica de su voz y posibles inferencias de salud</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Processing Purposes */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Finalidades del tratamiento</h2>
            <p className="text-[#374151] leading-relaxed text-base mb-4">
          ...
          {/* Legal Basis */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Bases jurídicas</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* AI Processing */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Cómo tratamos sus grabaciones con IA</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* DPIA */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Evaluación de Impacto en Protección de Datos (EIPD)</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Data Retention */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Conservación de datos</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Security Measures */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Medidas de seguridad</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Enhanced Rights */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Derechos reforzados y controles del usuario</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Minors */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Menores de edad</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Communications */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Comunicaciones y marketing</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Recipients */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Destinatarios y categorías de terceros</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Transferencias internacionales</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Cookies */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Cookies y tecnologías similares</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Analytics */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Información adicional sobre analítica y uso interno</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* California Users */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Usuarios de California y otros estados de EE. UU.</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          {/* Policy Updates */}
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Actualizaciones de esta Política</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          <section className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Resumen operativo de compromisos clave</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Cómo ejercer sus derechos o plantear dudas</h2>
            <p className="text-[#374151] leading-relaxed text-base">
          ...
          <section>
            <h2 className="text-xl font-bold mb-4 text-[#1e3a8a]">Anexo de aclaraciones sobre controles técnicos y de eliminación</h2>
            <p className="text-[#374151] leading-relaxed text-base">
      ...
      <footer className="border-t mt-20 py-8 bg-gray-50">
        <div className="container mx-auto px-6 text-center text-sm text-[#374151]">
          <p className="font-semibold">© 2025 Adagio. Todos los derechos reservados.</p>
